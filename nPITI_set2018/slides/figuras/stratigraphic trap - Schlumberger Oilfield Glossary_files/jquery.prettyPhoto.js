...
(function ($) {
    ...
    $.fn.prettyPhoto = function (settings) {
        ...
        var percentBased = false, correctSizes,
            ...
            $('div.pp_overlay').show().fadeTo(settings.animationSpeed, settings.opacity, function () {
                $pp_pic_holder.fadeIn(settings.animationSpeed, function () {
                    ...
                    if (pp_type == 'image') {
                        ...
                        if (pp_type == 'brightcove') {
                            //movie_width=640;
                            //movie_height=390;
                            pp_typeMarkup = grab_param('videoid', images[setPosition]);
                        } else if (pp_type == 'youtube') {
        ...
        */
        $.prettyPhoto.changePage = function (direction) {
            ...
            framecount('mediaWidget', location.href, 'toggle', tempCounter);
        ...
        */
        _showContent = function () {
            ...
            $pp_pic_holder.animate({
                ...
                if (pp_type == 'brightcove') BCL.addPlayer($pp_pic_holder.find('#pp_full_res')[0], pp_typeMarkup, movie_width, movie_height);
                //													pp_typeMarkup = images[setPosition];
            });
        };
        ...
        */
        function _fitToViewport(width, height) {
            ...
            windowHeight = $(window).height();
            windowWidth = $(window).width();
            if (((pp_containerWidth > windowWidth) || (pp_containerHeight > windowHeight)) && doresize && settings.allowresize && !percentBased && pp_type == "image") {
                hasBeenResized = true;
                notFitting = true;
        ...
        */
        function _getDimensions(width, height) {
            ...
            pp_containerWidth = width + 20; //joe changed to 20 // settings.padding;
        }

        function _getFileType(itemSrc) {
            if (itemSrc.match(/Brightcove/i)) {
                pp_type = 'brightcove';
            } else if (itemSrc.match(/youtube\.com\/watch/i)) {
                pp_type = 'youtube';
            } else if (itemSrc.indexOf('.mov') != -1) {
                pp_type = 'quicktime';
            } else if (itemSrc.indexOf('.swf') != -1) {
                pp_type = 'flash';
            } else if (itemSrc.indexOf('.ashx?t=swf') != -1) {
                pp_type = 'flash';
        ...
        function _buildOverlay() {
            ...
            toInject += '<div class="pp_pic_holder"><div class="pp_top"><div class="pp_left"></div><div class="pp_middle"></div><div class="pp_right"></div></div><div class="pp_content"><a href="#" class="pp_expand" title="Expand the image">Expand</a><div class="pp_loaderIcon"></div><div class="pp_hoverContainer"><a class="pp_next" href="#">next</a><a class="pp_previous" href="#">previous</a></div><div id="pp_full_res"></div><div class="pp_details clearfix"><p class="pp_description"></p><div class="pp_nav"><a href="#" class="pp_arrow_previous">Previous</a><a href="#" class="pp_arrow_next">Next</a><a class="pp_close" href="#">Close</a><p class="currentTextHolder">0' + settings.counter_separator_label + '0</p></div></div></div><div class="pp_bottom"><div class="pp_left"></div><div class="pp_middle"></div><div class="pp_right"></div></div></div>';
