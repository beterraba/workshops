...
function sendPage(id, querystring) {
	var querystring = querystring ? '&querystring=' + encodeURIComponent(querystring) : '';
    if (id) {
    	Popup('/forms/sendpage.aspx?id=' + id + querystring, 626, 436, 1, 'sendPage');
    }
}
